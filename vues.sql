...
--V6
CREATE OR REPLACE VIEW vue_admin AS
SELECT 
    r.refuge_id,
    r.nom AS nom_refuge,
    (SELECT COUNT(*) FROM animal a WHERE a.refuge_id = r.refuge_id) AS nb_animaux,
    (SELECT COUNT(*) FROM vue_adoption ad WHERE ad.refuge_id = r.refuge_id) AS nb_adoptions,
